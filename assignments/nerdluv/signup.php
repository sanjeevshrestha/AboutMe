...
<form name="frmSignup" action="signup-submit.php" method="POST">
	<fieldset>
		...
		<div class="row">
			...
			<input type="text" name="name" id="personality" size="6" maxlength="4" required="required"/> (<a href="http://www.humanmetrics.com/cgi-win/jtypes2.asp" target="_blank" title="Don't know your type">Don't Know your type</a>)
		</div>
		<div class="row">
		...
		<div class="row">
			<label for="age_min">Seeking Age:</label>
			<input type="text" name="age_min" id="age_min" size="6" placeholder="min" maxlength="2"/> to <input type="text" name="age_max"  id="age_max" size="6" placeholder="max" maxlength="2"/>
		</div>
		<div class="row">
